        ...
        <section className="about mt150">
            <div className="container">
                ...
                <div className="about__descrBlocks">
                    ...
                    <div className="about__descrBlocks_descr">Наши покупатели всегда остаются довольны <span className="circle__descrMiddle posTopRight"></span></div>
                    <div className="about__descrBlocks_descr" style={{ "margin": 0 }}>Ширикий ассортимент товаров для всей семьи</div>
                    <div className="about__descrBlocks_descr" style={{ "margin": 0, "marginTop": 98 }}>Возможность доставки в любой город Беларуси <span className="circle__descrMiddle"></span></div>
                    <div className="about__descrBlocks_descr" style={{ "margin": 0, "marginTop": 98 }}>Пункты выдачи заказов рядом с домом <span className="circle__descrSmall posTopRight"></span></div>
                </div>

            </div>
            <Fade bottom opposite when={active}>

                <div className="about_links pageUp">
                    <a href="#up" className="about__topBtn top right" onClick={scrollTop}>
                        {/* <div className="about__topBtn" > */}
                        <svg width="8" height="27" viewBox="0 0 8 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.35355 0.646446C4.15829 0.451185 3.84171 0.451185 3.64645 0.646446L0.464467 3.82843C0.269205 4.02369 0.269205 4.34027 0.464467 4.53553C0.659729 4.7308 0.976312 4.7308 1.17157 4.53553L4 1.70711L6.82843 4.53553C7.02369 4.7308 7.34027 4.7308 7.53553 4.53553C7.7308 4.34027 7.7308 4.02369 7.53553 3.82843L4.35355 0.646446ZM4.5 27L4.5 1L3.5 1L3.5 27L4.5 27Z" fill="#FFFDF5" />
                        </svg>
                        {/* </div> */}
                    </a>

                    <div className="about__topBtn top left">
