...
const AppFilterMatching = ({ getItemCatalogProducts, getOffSet }) => {
    ...
    const getItemProducts = async () => {
        productService.getFilteredProducts(offset).then(res => {
    ...
    return (
        <>
            <AppFilterInputImg getImgSrc={getImgSrc} newTaggingImg={newTaggingImg} getImgBase={getImgBase} />
            {inputImgSrc ? (
                <>
...
export default AppFilterMatching;