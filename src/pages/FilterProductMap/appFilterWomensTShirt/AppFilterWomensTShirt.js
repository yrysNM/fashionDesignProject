...
const AppFilterWomensTShirt = () => {
    ...
    useEffect(() => {
        getDataFilterWomensTShirt(true);
    }, [])
    ...
    const getDataFilterWomensTShirt = (initial) => {
        initial ? setNewItemLoading(false) : setNewItemLoading(true);
        getFilteredProducts(offset).then(res => {
            setNewItemLoading((newItemLoading) => false);
            setDataFilterProduct(dataFilterProduct => [...dataFilterProduct, ...res])
        });
    }
    ...
    const renderItems = () => {
        return (
            <>
                {dataFilterProduct.map((clothe, i) => {
                    return (
                        <div
                            key={i}
                ...
                <div className="container">
                    <div className="productMap_subtitle">
                        ...
                        <div className="productMap_link catalog_link">
                            ...
                            <span className="catalog_nowPath">Блузки и рубашки</span>

                        </div>
                    </div>
                    <div className="title mt94">
                        <h2 className="title_text">Блузки и рубашки для женщин</h2>
                    </div>
                    <div className="filterProducts__section">
                        ...
                        <div className="filterProducts__section-list">
                            {errorMessage}
                            {spinner}
                            {items}
                        </div>
                    ...
                    <div style={{ "minHeight": 130, "marginBottom": "66px", "marginTop": "61px" }}>
                        ...
                        <button disabled={newItemLoading}
                            onClick={offsetProducts} className="btn btn-more">
                            Ещё
