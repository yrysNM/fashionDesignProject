...
const ProductMap = () => {
    ...
    //TODO 
    const setlocalStorage = (keyLocalStorage) => {
        let obj = {
            "products": [],
        }
        ...
        let isEvenObj = {};
        const productId = location.pathname.slice(location.pathname.lastIndexOf("/") + 1, location.pathname.length);
        if (!isEvenObj[productId]) {

            isEvenObj[productId] = 1;
        ...
        if (localStorage.getItem(keyLocalStorage)) {
            ...
            const objLocalStorage = JSON.parse(localStorage.getItem(keyLocalStorage));

            objLocalStorage.forEach((item, i) => {
                ...
                if ((isEvenObj[item] % 2) === 0) {
                    delete isEvenObj[item];
                }
            });
        }
        obj.products = Object.keys(isEvenObj);
        localStorage.setItem(`${keyLocalStorage}`, JSON.stringify(obj.products));
    }
                            ...
                            <div className="productMap__blockInfo">
                                ...
                                <div className="productMap__data">
                                    ...
                                    <div className="productMap__busket">
                                        <button className="btn productMap__busket-btn" onClick={() => setlocalStorage("basketId")}>В корзину
                                        ...
                                        <div className="imgHeartIcon">
                                            <Link to="/favoriteProducts" onClick={() => setlocalStorage("favoriteId")}>
