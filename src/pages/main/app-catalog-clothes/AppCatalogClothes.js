    ...
    return (
        <section className="catalog mt150">
            <div className="container container_slide">
                <div className="title">
                    <h2 className="title_text pb60">Успей купить!
                    ...
                    <div className="catalog__blogs">
                        ...
                        <Swiper slidesPerView={4} navigation={true} spaceBetween={80} modules={[Navigation]}>
                            ...
                            <SwiperSlide>
                                ...
                                <div className="catalog__wrapper">
                                    <div className="catalog__wrapper_img">
                                        <img src={catalogImg1} alt="catalog img" width={300} height="319" />
                                    </div>
                                    <div className="catalog__info">
                                        <div className="catalog__item">
                            ...
                            <SwiperSlide>
                                ...
                                <div className="catalog__wrapper swiper-slide">
                                    <div className="catalog__wrapper_img">
                                        <img src={catalogImg2} alt="catalog img" width={300} height="319" />
                                    </div>
                                    <div className="catalog__info">
                                        <div className="catalog__item">
                            ...
                            <SwiperSlide>
                                ...
                                <div className="catalog__wrapper swiper-slide">
                                    <div className="catalog__wrapper_img">
                                        <img src={catalogImg3} alt="catalog img" width={300} height="319" />
                                    </div>
                                    <div className="catalog__info">
                                        <div className="catalog__item">
                            ...
                            <SwiperSlide>
                                ...
                                <div className="catalog__wrapper swiper-slide">
                                    <div className="catalog__wrapper_img">
                                        <img src={catalogImg4} alt="catalog img" width={300} height="319" />
                                    </div>
                                    <div className="catalog__info">
                                        <div className="catalog__item">
...
export default AppCatalogClothes;